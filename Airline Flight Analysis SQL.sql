...
--  Business Questions (to solve with SQL)
...
-- Price Change Trend by Days Left
...
-- Fastest Flight Options for Each Route
...
-- Airlines with Maximum Route Coverage
